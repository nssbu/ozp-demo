...
Changes 2013-01-02: Re-instating check for en/us for demandbase tracking
Changes 2013-01-11: incorporating Sam Jackson's re-write.
Changes 2013-02-05: evar57 Visitor ID and Support
Changes 2013-11-01: H26 update and Survey removed
Changes 2013-03-01: TNT and Analytics Mapping evar39 from evar51
Changes 2014-06-19: Move demandbase script to seperate file
*/

var s_account=metaData['repsuite']
...
function s_doPlugins(s) {
	...
	if(url) {
		...
		start1= url.indexOf("trackDownload('");
		start2= url.indexOf('trackDownload("');
		start3 = url.indexOf("trackDownloadFileOpen('");
		start4 = url.indexOf('trackDownloadFileOpen("');

		if(start1 != -1) {
		var end = url.indexOf("'" , start1 + 15);
		url = url.substring(start1 + 15, end);
		}
		if(start2 != -1) {
		var end = url.indexOf('"' , start2 + 15);
		url = url.substring(start2 + 15, end);
		}
		 if(start3 != -1) {
			var end = url.indexOf("'", start3 + 23);
			url = url.substring(start3 + 23, end);
		}
		 if(start4 != -1) {
			var end = url.indexOf('"', start4 + 23);
			url = url.substring(start4 + 23, end);
		}
	...
	s.pageName=((s.pageName == "none") || (s.pageName == "") || (s.pageName == undefined)) ? "" : s.pageName;
	if(s.pageName.substr(2,1) == "/") s.prop59 = s.pageName.substr(7,255);


	// KK 20111031 set via dymanic variables
	if(s.prop21) s.prop35 = '> ' + s.prop21 + ' ' + s.prop35;
	...
	if(!s.prop22) s.prop22 = s.getQueryParam('om_rssid');
	if(!s.prop22) s.prop22 = s.getQueryParam('om_ext_cid');

	om_temp = s.getQueryParam('om_sem_eid');
	if(om_temp) s.prop22 += '_' + om_temp;

	om_temp = s.getQueryParam('om_sem_adid');
	if(om_temp) s.prop22 += '_' + om_temp;
	...
	s.prop26 = s.getQueryParam('om_sem_kw');
	s.prop26 = s.getValOnce(s.prop26,'s_prop26',30);
	s.eVar45 = s.prop26;

	s.prop56 = s.getQueryParam('aid');
	s.eVar2 = s.prop56

	om_temp = s.getQueryParam('om_sem_site');
	if(om_temp) s.eVar17 = s.getValOnce(om_temp,'s_eVar17',30);

	if(s.campaign) s.prop35 = '> ' + s.campaign + ' ' + s.prop35;
	...
	s.prop2=((s.prop2 == "none") || (s.prop2 == "") || (s.prop2 == undefined)) ? "n/a" : s.prop2;
	s.prop3=((s.prop3 == "none") || (s.prop3 == "") || (s.prop3 == undefined)) ? "n/a" : s.prop3;
	s.channel=((s.channel == "none") || (s.channel == "") || (s.channel == undefined)) ? "n/a" : s.channel;
	s.prop27=((s.prop27 == "none") || (s.prop27 == "") || (s.prop27 == undefined)) ? "n/a" : s.prop27;
	s.prop30=((s.prop30 == "none") || (s.prop30 == "") || (s.prop30 == undefined)) ? "n/a" : s.prop30;
	s.prop41=((s.prop41 == "none") || (s.prop41 == "") || (s.prop41 == undefined)) ? "n/a" : s.prop41;
	s.prop48=((s.prop48 == "none") || (s.prop48 == "") || (s.prop48 == undefined)) ? "n/a" : s.prop48;
	s.prop49=((s.prop49 == "none") || (s.prop49 == "") || (s.prop49 == undefined)) ? "n/a" : s.prop49;
	s.prop58=((s.prop58 == "none") || (s.prop58 == '') || (s.prop58 == undefined)) ? "n/a" : s.prop58;
	s.prop59=((s.prop59 == "none") || (s.prop59 == "") || (s.prop59 == undefined)) ? "n/a" : s.prop59;
	...
	s.eVar29  = "D=channel" ;
	if(s.prop2 != "n/a")  s.eVar27 = "D=c2" ;
	if(s.prop3 != "n/a")  s.eVar28 = "D=c3" ;
	if(s.prop27 != "n/a") s.eVar50 = "D=c27" ;
	if(s.prop30 != "n/a") s.eVar32 = "D=c30" ;
	if(s.prop41 != "n/a") s.eVar41 = "D=c41" ;
	if(s.prop48 != "n/a") s.eVar49 = "D=c48" ;
	if(s.prop49 != "n/a") s.eVar48 = "D=c49" ;
	if(s.prop58 != "n/a") s.eVar58 = "D=c58" ;
	if(s.prop59 != "n/a") s.eVar59 = "D=c59" ;


	/***** KK 20111031 added for reviousvalue tacking *****/
	s.prop60=s.getPreviousValue(s.pageName,'s_gpv','');


	/***** cross visit participation *****/
	// Campaign stacking - 0712 - moved from evar15 to evar63
	s.eVar63=s.crossVisitParticipation(s.campaign,'s_eVar15','90','10',',','purchase',0);


	/***** KK added for repeat visitor *****/
	 /* First Time Visitor  */
...
s.inlineStatsHandleMovie("ghpFlash")
